<div class="grid grid-cols-12 col-span-2 gap-5 py-4 mb-5 justify-evenly">
    <a class="content-start col-span-5 px-8 py-5 text-left duration-1000 ease-in-out border rounded-md shadow-md border-lime-900 shadow-lime-900 "
        style="background-image: linear-gradient(115deg, #dcfdd6, #b9ffb8)">
        <div class="grid grid-cols-3">
            <div class="col-span-2">
                <p class="pb-3 text-lg font-extrabold text-lime-800">Overall Gross Sales (₱)</p>
    ...
    <a class="content-start col-span-2 px-8 py-5 text-left duration-1000 ease-in-out border border-teal-900 rounded-md shadow-md shadow-teal-900 "
        ...
        <div class="grid grid-cols-3">
            ...
            <div class="col-span-1 m-auto">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="text-teal-900 size-14 opacity-2">
                    <path stroke-linecap="round" stroke-linejoin="round"
    ...
    <div class="content-start col-span-2 px-8 py-5 text-left duration-1000 ease-in-out border border-pink-900 rounded-md shadow-md shadow-pink-900 "
        ...
        <div class="grid grid-cols-3">
            ...
            <div class="col-span-1 m-auto">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="text-pink-900 size-14 opacity-2">
                    <path stroke-linecap="round" stroke-linejoin="round"
