    ...
    <div wire:ignore>
        ...
        <div class="p-4 bg-white border border-[rgb(143,143,143)] shadow-2xl rounded-lg">
            <div class="flex flex-row justify-between ">
                ...
                <select name="year" class="p-2 text-center text-orange-900 transition-all duration-100 ease-in-out bg-orange-200 border border-orange-900 rounded-lg hover:font-bold hover:bg-orange-400 "
