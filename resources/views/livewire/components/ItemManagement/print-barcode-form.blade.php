                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between gap-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <label for="asas" class="block mb-2 text-sm font-medium text-gray-900 ">Barcode:
                                        {{ $barcode }}
                                    </label>

                                    <img id="barcode" wire:model="barcode">{!! DNS1D::getBarcodeSVG($barcode, 'EAN13',
                                    2, 60) !!}</img>
                                ...
                                <div class="mb-3">
                                    ...
                                    <img id="barcode" wire:model="barcode">{!! DNS1D::getBarcodeSVG($barcode, 'UPCA', 2,
                                    60) !!}</img>
