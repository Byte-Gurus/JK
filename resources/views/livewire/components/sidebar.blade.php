<div x-cloak class="h-screen fixed w-[220px] bg-[#272727] text-center gap-12 z-50">
    ...
    <nav class="flex flex-col gap-12 text-center ">
        <ul class="flex flex-col w-full gap-2 mt-4">
            ...
            <li>
                <a href=" {{ route('customercreditmanagement.index') }} " wire:navigate
                    class="w-full bg-transparent text-sm font-medium text-[#EFEFEF] hover:bg-[#464646] px-6 py-2 flex flex-row gap-4 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('purchaseanddeliverymanagement.index') }}" wire:navigate
                    class="w-full bg-transparent text-sm font-medium text-[#EFEFEF] hover:bg-[#464646] px-6 py-2 flex flex-row gap-4 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('suppliermanagement.index') }}" wire:navigate
                    class="w-full bg-transparent text-sm font-medium text-[#EFEFEF] hover:bg-[#464646] px-6 py-2 flex flex-row gap-4 items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
