                                ...
                                <li class="flex items-start justify-between">
                                    ...
                                    <div class="flex flex-row items-center self-center justify-between gap-2 pr-2 ">
                                        ...
                                        <p class="text-[1.5em] font-bold ">
                                            {{ number_format($item->inventoryJoin->selling_price, 2) }}
                                    </div>
                                </li>
                            </ul>
                        @endforeach
                    ...
                    @if (!empty($credit_no))
                        <div wire:click='clearSelectedCustomerName()' class="flex justify-end">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                strokeWidth={1.5} stroke="currentColor" class="text-red-500 size-8">
                                <path strokeLinecap="round" strokeLinejoin="round"
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="p-2">
                            ...
                            <div class="flex flex-row justify-between">
                                ...
                                <p class=" text-[1.2em] font-black">
                                    {{ number_format($transactionDiscount, 2) ?? ' ' }}
                                </p>
                            </div>
                            <div class="flex flex-row justify-between">
