        ...
        <div class="flex flex-row justify-between gap-4 pb-[28px]">
            <div class="w-2/4">
                ...
                <img id="dimg_DGjVZrqyIPnd2roPzvzYmQc_249"
                    ...
                    @if (!empty($search)) <div class="absolute w-1/3 h-fit max-h-[400px] overflow-y-scroll bg-[rgb(248,248,248)]">
                                ...
                                <tr wire:click="getIndex({{ $index }}, true )" x-data="{ isSelected: false }"
                                    ...
                                    <th scope="row"
                                        ...
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <div>
                                                <div
                                                    class="text-sm text-left italic font-medium text-[rgb(122,122,122)]">
                                                    {{ $selectedItem['barcode'] }}</div>
                                            </div>
                                        </div>
                                    </th>
                            ...
                            <div
                                ...
                                @if (!empty($selectedItems))
                                    <button wire:click="removeItem"
                                        x-on:keydown.window.prevent.ctrl.3="$wire.call('removeItem')"
                                        class="px-8 py-2 ">
                                        Remove Item
                                    </button>
                                @else
