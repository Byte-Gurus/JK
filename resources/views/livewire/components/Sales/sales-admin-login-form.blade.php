        ...
        <div
            ...
            <form wire:submit.prevent="authenticate" class="flex flex-col justify-center w-full flex-nowrap text-nowrap">
                ...
                <div class="flex flex-col mb-12" x-data="{ showPassword: @entangle('showPassword') }">
                    ...
                    <input :type="showPassword ? 'password' : 'test'" id="password" name="password" required
                    ...
                    @else
                        <p class="fixed self-end mt-8 mr-4 cursor-pointer " x-on:click=" $wire.showPasswordStatus()">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
