<div class="relative" x-cloak x-show="showSalesReturnForm">
    ...
    <div
        ...
        <form class="relative z-50 w-1/3 bg-[rgb(238,238,238)] rounded-lg shadow " wire:submit.prevent="return">
            ...
            <div class="flex items-center justify-between px-6 py-2 border-b rounded-t ">
                ...
                {{-- //* close button --}}
                <button type="button" x-on:click="showSalesReturnForm=false" wire:click=' resetFormWhenClosed() '
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="border-2 border-[rgb(53,53,53)] rounded-md">
                        ...
                        <div
                            ...
                            <h1 class="font-bold">Sales Return Information</h1>
                        </div>
