<div class="relative" x-cloak x-show="showWholesaleForm">
    ...
    <div
        ...
        <form class="relative z-50 w-1/3 bg-[rgb(238,238,238)] rounded-lg shadow " wire:submit.prevent="adjust">
            ...
            <div class="flex items-center justify-between px-6 py-2 border-b rounded-t ">
                ...
                {{-- //* close button --}}
                <button type="button" x-on:click="showWholesaleForm=false" wire:click='resetFormWhenClosed'
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="border-2 border-[rgb(53,53,53)] rounded-md">
                        ...
                        <div
                            ...
                            <h1 class="font-bold">Wholesale Information</h1>
                        </div>
                        ...
                        <div class="p-4">
                            ...
                            <div class="flex justify-between gap-4">
                                ...
                                <div class="flex flex-col gap-1 mb-3">
                                    ...
                                    <div>
                                        <label for="discount_percentage" class="text-[1.2em] text-gray-900">Discount (%)</label>
                                    </div>

                                    <div>
                                        <input type="text" wire:model='discount_percentage' placeholder="Discount Percentage"
                                            required
                                            class=" bg-[rgb(245,245,245)] border border-[rgb(143,143,143)] text-gray-900 text-sm rounded-lg  block w-full p-2.5">
                                    </div>
