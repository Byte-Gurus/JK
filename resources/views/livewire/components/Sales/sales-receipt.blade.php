        ...
        <div class="w-full border-2 h-fit">
            ...
            <div class="flex flex-col justify-between px-4 mb-2">
                <div class="flex flex-col ">
                    ...
                    <div class="flex flex-row text-nowrap">
                        <p class="text-[0.6em]">Prepared By:</p>
                        <p class="text-[0.6em]">{{ $receiptDetails['transaction_info']['transaction_no'] ?? null }}</p>
                    </div>
                </div>
            </div>
                ...
                <table class="w-full h-10 text-sm text-left scroll no-scrollbar">
                    ...
                    <thead class="sticky top-0 w-full text-black uppercase border-b-2 border-black cursor-default ">
                        ...
                        <tr>
                            ...
                            {{-- //* status --}}
                            <th scope="col" class="text-[0.6em] text-center">
                                <p>Price</p>
                            </th>
                                ...
                                <tr>
                                    <th scope="row">
                                        <div class="flex flex-col max-w-[48px]">
                                            <p class="text-[0.8em] font-bold break-all leading-none mt-1">
                                                {{ $item['item_name'] }}
                                            </p>
                                            <p
                                                class="text-[0.8em] text-wrap  break-all font-medium leading-none mt-[2px] mb-1">
                                                {{ $item['item_description'] }}</p>
                                        </div>
                                    </th>
                                    <th scope="row">
                                        <div>
                                            <p class="text-[0.8em] italic text-center font-medium">
                                                x{{ $item['quantity'] }}</p>
                                        </div>
                                    </th>
                                    <th scope="row">
            ...
            <div class="flex flex-col gap-1 px-2 m-2">
                ...
                <div class="flex flex-row justify-between">
                    <p class="text-[0.6em]">Discount - SC/PWD (20%)</p>
                    <p class="text-[0.6em]">
