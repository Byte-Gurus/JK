<div x-cloak>
    <div class="flex flex-col">
        ...
        <div class="flex flex-col h-full max-h-[620px]">
            <div class="flex justify-end w-full mb-[28px]">
                <button type="button"
            ...
            <div class="w-full h-full rounded-md ">
                <div
                    class="w-full h-[260px] mb-4 bg-orange-100  overflow-x-auto overflow-y-scroll border border-black scroll ">

                    <table class="w-full h-10 text-sm text-left scroll no-scrollbar">

                        {{-- //* table header --}}
                        <thead
                            class="text-xs text-white z-10 uppercase cursor-default bg-[rgb(53,53,53)] sticky top-0   ">
                ...
                <div class="row-span-1 p-4 bg-orange-200 border border-black rounded-2xl">

                    <div class="flex flex-col justify-around h-full gap-2 text-wrap">
