<div x-cloak class="flex flex-col">
    ...
    <div class="flex flex-col">
            ...
            <table class="w-full text-sm text-left scroll no-scrollbar">
                ...
                <thead class="text-xs text-white uppercase cursor-default bg-[rgb(53,53,53)] sticky top-0">
                    ...
                    <tr class=" text-nowrap">
                        ...
                        @if (in_array('Exchange', $operation))
                            {{-- Available Stock --}}
                            <th scope="col" class="px-4 py-3 text-center">Available Stock</th>

                            {{-- Refund Quantity --}}
                            <th scope="col" class="px-4 py-3 text-center">Refunded Quantity</th>
                        @endif
        ...
        <div
            class="flex flex-col justify-around row-span-1 gap-2 px-4 py-2 leading-none bg-orange-100 border border-black text-wrap rounded-b-2xl">
            ...
            <div class="flex flex-row justify-between">
                ...
                <div>
                    <p class=" text-[1.2em] font-black"> {{ number_format($total_amount, 2) }}</p>

                </div>
            </div>
            <div class="flex flex-row justify-between">
                <div>
                    <p class=" text-[1.2em] font-thin">Amount to Refund</p>
                </div>
                <div>
                    <p class=" text-[1.2em] font-medium">₱{{ number_format($total_refund_amount, 2) }}</p>
                </div>
            </div>
            <div class="flex flex-row justify-between">
                <div>
                    <p class=" text-[1.2em] font-thin">Exchange Amount</p>
                </div>
                <div>
                    <p class=" text-[1.2em] font-medium">₱{{ number_format($total_exchange_amount, 2) }}</p>
                </div>
            </div>
            <div class="flex flex-row justify-between">
                <div>
                ...
                <div>
                    <p class=" text-[1.2em] font-bold">₱{{ number_format($return_total_amount, 2) }}</p>
                </div>
            </div>
