                                    ...
                                    {{-- <div class="grid justify-between grid-flow-col grid-cols-2 gap-4"
                                        ...
                                        <div class="flex flex-wrap items-center justify-center mb-3">
                                            <div class="flex flex-col gap-2">
                                                <input type="file" id="user_image" wire:model="user_image" required
                        ...
                        <div class="border-2 border-[rgb(53,53,53)] rounded-sm">
                            ...
                            <div class="p-4">
                                ...
                                <div x-show="showPassword" x-cloak
                                    class="relative transition-all duration-100 ease-in-out">

                                    {{-- //* password --}}
                                    <div class="relative flex flex-col mb-3"
                                        x-data="{ unhidePassword: @entangle('unhidePassword') }">
                                        <label for="password"
                                            class="block mb-2 text-sm font-medium text-gray-900 ">Password</label>
                                        <input :type="unhidePassword ? 'password' : 'text'" id="password"
                                ...
                                {{-- //* check box for edit --}}
                                @if (!$this->isCreate)
                                <input type="checkbox" name="showpassword" id="showpassword" wire:model="show_password"
                                    placeholder="">
