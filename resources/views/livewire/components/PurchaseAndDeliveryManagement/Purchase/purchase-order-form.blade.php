        ...
        <form wire:submit.prevent="create">
            ...
            <div class="grid grid-flow-col grid-cols-12 gap-4">
                                    ...
                                    <tr
                                        ...
                                        <th scope="row"
                                            ...
                                            <div class="flex justify-center">
                                                <input type="checkbox"
                                                    wire:model.live="toOrderItems.{{ $index }}"
                ...
                <div class="flex flex-col col-span-3">
                                    ...
                                    <div class="p-2 bg-[rgb(255,248,237)] border border-black rounded-lg">
                                        ...
                                        <div class="grid grid-flow-col ">
                                            <div class="flex flex-row items-center justify-start gap-4">
                                                ...
                                                <p
                                                    class="pb-[1px] pt-[2.4px] text-sm font-medium border-b border-black">
                    ...
                    @else
                        <div
                            class="border col-span-1 flex-col rounded-lg bg-[#FCFCF2] shadow-lg border-[rgb(143,143,143)]">
                            <div
