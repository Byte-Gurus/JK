...
<div class="relative" x-show="showModal" x-cloak x-data="{ isCreate: @entangle('isCreate'), showModal: @entangle('showModal') }">
    <div class="flex flex-row gap-4 h-[640px] ">
        ...
        <div class="relative w-full overflow-hidden bg-white border border-black shadow-lg sm:rounded-lg">
                    ...
                    <tbody>
                        @foreach ($reorder_lists as $index => $reorder_list)
                            <tr
                                ...
                                <th scope="row"
                                    class="flex justify-center px-2 py-4 font-medium text-gray-900 text-clip text-md whitespace-nowrap">
                                    <input type="number"
        ...
        <div class="relative w-1/2 overflow-hidden border border-black shadow-md shadow-lg box bg-gray-50 sm:rounded-lg">
            ...
            <div class="flex justify-center px-2 py-10">
                <div>
                    <h1 class="text-[1.8em]">Removed Items</h1>
                </div>
