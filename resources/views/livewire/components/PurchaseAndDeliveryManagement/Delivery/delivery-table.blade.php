                            ...
                            <th scope="row"
                                ...
                                <div class="flex justify-center ">
                                    ...
                                    @if ($delivery->status === 'Cancelled')
                                        <p>N/A</p>
                                    @elseif ($delivery->status === 'In Progress')
                                        <button wire:click='displayDeliveryDatePicker()' class="px-4 py-2 font-bold transition-none ease-in-out bg-green-200 rounded-lg hover:bg-green-400 duration-0">SET DELIVERY DATE</button>
                                        {{-- <input type="date"
