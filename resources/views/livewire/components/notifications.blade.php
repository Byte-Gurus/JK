<div
    class=" flex flex-col gap-2 font-bold overflow-auto bg-[rgba(53,53,53,0.98)] blur-sm h-screen max-h-[400px] rounded-md px-4 py-2">
    @foreach ($notifications as $notification)
        <div class=" h-fit bg-[rgb(36,36,36)] rounded-sm">


            <p @if ($notification->inventoryJoin) wire:click="goToOtherPage({{ $notification->inventory_id }}, 'inventory')"
