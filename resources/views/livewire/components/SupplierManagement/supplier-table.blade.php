                    ...
                    @foreach ($suppliers as $supplier)
                        <tr
                            ...
                            <th scope="row"
                                ...
                                <p
                                    @if ($supplier->statusJoin->status_type == 'Active') class=" text-green-900 font-medium
                                ...
                                <div x-data="{ openActions: false }">
                                    ...
                                    min-h-[20%]">
                                            <div class="flex flex-col font-black bg-[rgba(53,53,53,0.95)]">
                                                ...
                                                <button
                                                    x-on:click=" showModal=true;$wire.getSupplierID({{ $supplier->id }}),
                                                    openActions= !openActions "


                                                    {{-- wire:click="getStockPrice({{
                                                $inventory->id }})" --}}
