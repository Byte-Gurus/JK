                ...
                <div class="flex flex-row items-center gap-4 mb-4">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <select wire:model.live="supplierFilter"
                            class="bg-gray-50 border border-[rgb(53,53,53)] hover:bg-[rgb(225,225,225)] transition text-ellipsis w-[180px] duration-100 ease-in-out text-[rgb(53,53,53)] text-sm rounded-md block p-3 ">
                            <option value="0">All</option>
