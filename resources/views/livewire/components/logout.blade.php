...
<div>
    <button data-modal-target="popup-modal" data-modal-toggle="popup-modal"
        class="block text-[rgb(53,53,53)] bg-[rgb(255,133,133)] focus:ring-4 focus:outline-none  font-bold rounded-lg text-sm px-4 py-2 text-center hover:bg-[rgb(255,94,94)] hover:text-white transition-all ease-in-out duration-100 "
        type="button">
