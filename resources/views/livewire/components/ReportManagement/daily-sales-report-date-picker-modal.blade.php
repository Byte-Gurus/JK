                        ...
                        <div>
                            ...
                            @else
                                <button type="button" wire:click="getDate" disabled
                                    ...
                                    class=" px-6 py-2 bg-[rgb(75,102,105)] rounded-md text-[rgb(30,30,30)] hover:bg-[rgb(97,204,219)] font-bold ease-in-out duration-100 transition-all">Generate</button>
                            @endif
