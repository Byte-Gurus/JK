<div x-cloak class="flex justify-center h-fit">
    ...
    <div class="  w-[816px] border border-black">
        ...
        <div>
            <p class="text-[2em] font-bold text-right italic m-4 mr-8 uppercase">DAILY SALES REPORT</p>
        </div>
                        ...
                        <li class="col-span-1 py-[3px]">
                            <div>
                                <p class="text-[0.8em] text-right font-bold">
                                    ...
                                    @elseif ($transaction->transaction_type == 'Void')
                                        {{ number_format(
                                            ($transaction->voidTransactionJoin->void_total_amount - $transaction->voidTransactionJoin->void_vat_amount) * -1,
                                            2,
                                        ) }}
                                    @endif
                                </p>
