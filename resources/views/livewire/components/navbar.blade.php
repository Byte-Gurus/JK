        ...
        <div class="flex items-center justify-between">
            <div class="flex flex-row items-center gap-10">
                ...
                <div x-data="{ openNotifications: false }" x-on:click.away="openNotifications = false;"
                    ...
                    <div
                        class="absolute pointer-events-none top-0 right-0 bg-[rgb(255,190,99)] px-[4px] py-[2px] rounded-full translate-x-3 translate-y-[-12px]">
                        <p class=" text-[0.6em] font-bold">{{$notificationCount}}</p>
                    </div>
                    @endif
