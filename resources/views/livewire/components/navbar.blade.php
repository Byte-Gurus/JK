<div x-data="{ openSidebar: @entangle('sidebarOpen') }" x-cloak
    ...
    ease-out border-b-2 border-black px-[3vh] text-nowrap" @endif>
    ...
    <div class="flex items-center">
        ...
        <div class="flex items-center justify-between">
            <div class="relative p-1.5 hover:bg-[rgb(231,231,231)] rounded-full ease-in-out transition-all duration-200 cursor-pointer">
            ...
            <div class="flex flex-row items-center gap-8">
                ...
                <div x-data="{ openNotifications: false }" x-on:click.away="openNotifications = false;"
                    ...
                    <div x-show="!openNotifications"
                        class="absolute pointer-events-none top-0 right-0 bg-[rgb(255,190,99)] px-[4px] py-[2px] rounded-full translate-x-[-5px] translate-y-[-1px]">
                        <p class=" text-[0.4em] font-black">!</p>
                    </div> --}}
