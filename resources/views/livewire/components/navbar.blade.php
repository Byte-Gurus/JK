<div x-data="{ openSidebar: @entangle('sidebarOpen') }"
    x-cloak
    @if ($this->sidebarOpen)
        class="z-50 flex flex-row font-['Inter'] items-center justify-between py-2 transition-all duration-100 ease-out border-b-2 border-black px-[3vh] text-nowrap"
    @else
    class="flex flex-row items-center font-['Inter'] justify-between ml-[0px] z-50 py-2 transition-all duration-100 ease-out border-b-2 border-black px-[3vh] text-nowrap"
    @endif
    >
