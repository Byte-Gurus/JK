<div x-data="{ sidebar: @entangle('sidebarStatus') }" @if (!$this->sidebarStatus) class=" ml-[220px] transition-all
    ...
    <div x-show="showDailySalesReportDatePickerModal"
        x-data="{ showDailySalesReportDatePickerModal: @entangle('showDailySalesReportDatePickerModal') }">
    ...
    <div x-show="showWeeklySalesReportDatePickerModal"
        x-data="{ showWeeklySalesReportDatePickerModal: @entangle('showWeeklySalesReportDatePickerModal') }">
    ...
    <div x-show="showMonthlySalesReportDatePickerModal"
        x-data="{ showMonthlySalesReportDatePickerModal: @entangle('showMonthlySalesReportDatePickerModal') }">
    ...
    <div x-show="showYearlySalesReportDatePickerModal"
        x-data="{ showYearlySalesReportDatePickerModal: @entangle('showYearlySalesReportDatePickerModal') }">
    ...
    <div x-show="showSalesReturnReportDatePickerModal"
        x-data="{ showSalesReturnReportDatePickerModal: @entangle('showSalesReturnReportDatePickerModal') }">
        @livewire('components.ReportManagement.sales-return-report-date-picker-modal')
    </div>

    {{-- Voided Transactions --}}

    <div x-show="showVoidedTransactionsReport"
        x-data="{ showVoidedTransactionsReport: @entangle('showVoidedTransactionsReport') }">
        @livewire('components.ReportManagement.voided-transactions-report')
    </div>

    <div x-show="showVoidedTransactionsReportDatePickerModal"
        x-data="{ showVoidedTransactionsReportDatePickerModal: @entangle('showVoidedTransactionsReportDatePickerModal') }">
        @livewire('components.ReportManagement.voided-transactions-report-date-picker-modal')
    </div>

    {{-- Customer Credit --}}

    <div x-show="showCustomerCreditListReport"
        x-data="{ showCustomerCreditListReport: @entangle('showCustomerCreditListReport') }">
        @livewire('components.ReportManagement.customer-credit-list-report')
    </div>

    <div x-show="showCustomerCreditListReportDatePickerModal"
        x-data="{ showCustomerCreditListReportDatePickerModal: @entangle('showCustomerCreditListReportDatePickerModal') }">
    ...
    <div x-show="showSlowMovingItemsReportDatePickerModal"
        x-data="{ showSlowMovingItemsReportDatePickerModal: @entangle('showSlowMovingItemsReportDatePickerModal') }">
        @livewire('components.ReportManagement.slow-moving-items-report-date-picker-modal')
    </div>

    <div x-show="showSlowMovingItemsReport"
        x-data="{ showSlowMovingItemsReport: @entangle('showSlowMovingItemsReport') }">
        @livewire('components.ReportManagement.slow-moving-items-report')
    </div>

    {{-- Fast Moving Items --}}

    <div x-show="showFastMovingItemsReport"
        x-data="{ showFastMovingItemsReport: @entangle('showFastMovingItemsReport') }">
        @livewire('components.ReportManagement.fast-moving-items-report')
    </div>

    <div x-show="showFastMovingItemsReportDatePickerModal"
        x-data="{ showFastMovingItemsReportDatePickerModal: @entangle('showFastMovingItemsReportDatePickerModal') }">
    ...
    <div x-show="showBackorderedItemsReport"
        x-data="{ showBackorderedItemsReport: @entangle('showBackorderedItemsReport') }">
    ...
    <div x-show="showExpiredItemsReportDatePickerModal"
        x-data="{ showExpiredItemsReportDatePickerModal: @entangle('showExpiredItemsReportDatePickerModal') }">
    ...
    <div x-show="showDamagedItemsReportDatePickerModal"
        x-data="{ showDamagedItemsReportDatePickerModal: @entangle('showDamagedItemsReportDatePickerModal') }">
