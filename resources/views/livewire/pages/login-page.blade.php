...
<div
    class="flex justify-center mx-auto overflow-hidden align-middle border-2 border-black w-fit rounded-xl vsm:flex-col vsm:w-fit phone:flex-col phone:p-18 phone:w-fit tablet:flex-col tablet-1/2 laptop:flex-row">
    <div
        class=" flex flex-col gap-4 items-center justify-center
    vsm:bg-[rgb(255,255,255)] vsm:w-fit  vsm:p-4 vsm:rounded-tl-xl vsm:rounded-tr-xl vsm:rounded-bl-none vsm:rounded-br-none
    phone:bg-[rgb(243,252,190)] phone:w-screen phone:p-4 phone:rounded-tl-xl phone:rounded-tr-xl phone:rounded-bl-none phone:rounded-br-none
     ...
     laptop:bg-[rgb(53,53,53)] laptop:p-8 laptop:w-fit laptop:rounded-tl-xl laptop:rounded-bl-xl laptop:rounded-tr-none laptop:rounded-br-none ">
        <img src="jk-logo-cropped.png" alt="jk" class="vsm:w-1/5 phone:w-1/4 tablet:w-2/4 laptop:w-2/4">
        <p
            class="text-[rgb(241,241,241)] font-bold text-center pointer-events-none
                vsm:text-[1em]
                phone:text-[1.2em]
                tablet:text-[1.2em]
                laptop:text-[1.6em]">
    ...
    <div
        ...
        <form wire:submit.prevent="authenticate"
            ...
            <div class="laptop:text-right">
                <button type="submit"
                    class="w-full px-8 py-2 font-bold text-[rgb(249,249,249)] bg-[rgb(53,53,53)] border-2 border-black rounded-md text-md hover:bg-[rgb(80,80,80)] ">
                    Sign In</button>
            </div>
