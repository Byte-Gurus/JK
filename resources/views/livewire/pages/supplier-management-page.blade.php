<div>
    ...
    <div x-data="{ showModal: @entangle('showModal') }">
        <div class=" ml-[250px] py-[28px] mr-8">
            <div class="flex flex-col justify-between">
                <div class="flex flex-row items-center justify-between">
                    ...
                    <div class="flex flex-row gap-2">
                        ...
                        <div>
                            <button
                                class=" px-4 py-2 text-sm font-bold flex flex-row items-center gap-2 bg-[rgb(180,196,255)] text-[rgb(53,53,53)] border rounded-md hover:bg-[rgb(134,160,255)] hover:translate-y-[-2px] transition-all duration-100 ease-in-out"
                                x-on:click="showModal=true;$wire.formCreate()">
            ...
            {{-- @livewire('components.UserManagement.supplier-form') --}}
        </div>
        {{-- @livewire('components.UserManagement.supplier-table') --}}
    </div>
</div>
